        ...
        <div class=" w-[400px] bg-slate-50 px-4 py-8 rounded shadow-2xl  ">
            <form action="login_db.php" method="post">
                ...
                <div class="flex justify-end">
                    <button type="submit" name="loginSubmit" class="text-white bg-purple-700 hover:bg-purple-800 focus:outline-none font-medium rounded-lg text-sm w-full sm:w-auto px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">เข้าสู่ระบบ</button>
                </div>
                <div class="text-sm flex justify-center mt-4">
                    <div class="text-gray-500">ยังไม่มีบัญชีใช่ไหม?</div><a class="font-medium ml-1" href="../register/">ลงทะเบียน</a>
                </div>
            </form>
        </div>
