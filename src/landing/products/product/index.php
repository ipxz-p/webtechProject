        ...
        <div class="palm-container flex flex-col lg:flex-row">
            ...
            <div class="w-full lg:min-w-[275px] lg:max-w-[275px] w-full mt-[10px] lg:mt-0 lg:ml-4 lg:ml-8">
                ...
                <div class="flex justify-between items-center mt-6">
                    <button onclick="addToCart(event, <?php echo $test ?>, <?php echo $row['cost']; ?>, '<?php echo $row['name']; ?>', '<?php echo $img4 ?>', '<?php echo $row['des']; ?>')" class="transition duration-500 bg-purple-500 hover:bg-purple-400 text-center text-white w-full mr-3 py-2 rounded-3xl">
                        ใส่ตะกร้า
                    </button>
                    ...
                    <div onclick="addToWishList(event, <?php echo $test ?>, <?php echo $row['cost']; ?>, '<?php echo $row['name']; ?>', '<?php echo $img4 ?>', '<?php echo $row['des']; ?>')" class="border-2 border-red-500 rounded-3xl p-2 cursor-pointer">
